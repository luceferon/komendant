...
begin
  ...
  try
    ...
    begin
      ...
      var KolvoMest := UniQuery.FieldByName('Кол_во_мест').AsString;
      ...
      UniQuery.SQL.Text := 'INSERT INTO ' + FTableNameKuda +
        ...
        '`Контактный_телефон`, `Кол_во_мест`, `Номер`) VALUES (:fio, :comment, :datazaezda, :dolznost, :org, :tel, :kolvoMest, :komnata)';
      UniQuery.Params.ParamByName('fio').AsString := FIOSotrud;
