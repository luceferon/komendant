...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.CBCompany.addItems(["ООО \"А-Сервис\"", "ООО \"Еда\"", "ООО \"Комплектсервис\"",
                                 "ООО \"МоторСервис\"", "ООО \"Сисим\"", "ООО \"СпецПодряд\"", "ООО \"КрасИнтегра\""])
        self.CBDolznost.addItems(["Машинист бульдозера", "Машинист экскаватора", "Горный мастер",
                                  ...
                                  "Кладовщик ТМЦ", "Геолог", "Маркшейдер", "Старший повар", "Водитель крана"])
